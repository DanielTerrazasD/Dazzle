...
uniform struct Light
{
    ...
    vec3 Lv;            // (vec3) Light Position In View Coordinates
} light;
...
void main(void)
{
    ...
    vec3 lightDirection = normalize(-light.Lv);
    ...
    if ( sDotN > 0.0 )
    {
        ...
        // reflection = Reflected vector of the "-lightDirection" vector with respect to "surfaceNormal".
